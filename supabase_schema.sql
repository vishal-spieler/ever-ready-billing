...
-- 7. Add Authentication & Purchase Orders (Phase 4 Upgrade)
ALTER TABLE company_settings ADD COLUMN IF NOT EXISTS login_username TEXT DEFAULT 'admin';
ALTER TABLE company_settings ADD COLUMN IF NOT EXISTS login_password TEXT DEFAULT 'admin123';
...
CREATE TABLE IF NOT EXISTS purchase_orders (
  ...
  valid_until text,
  client_id bigint NOT NULL,
  vendor_or_client text NOT NULL DEFAULT 'CLIENT', -- 'VENDOR', 'CLIENT'
  tax_type text NOT NULL, -- 'CGST_SGST', 'IGST', 'NONE'
  cgst_rate numeric DEFAULT 9,
  sgst_rate numeric DEFAULT 9,
  igst_rate numeric DEFAULT 18,
...
-- Align identity sequences for new tables
...
SELECT setval(pg_get_serial_sequence('uploaded_pos', 'id'), coalesce(max(id), 1)) FROM uploaded_pos;

-- Disable RLS for new tables
ALTER TABLE purchase_orders DISABLE ROW LEVEL SECURITY;
ALTER TABLE purchase_order_items DISABLE ROW LEVEL SECURITY;
ALTER TABLE uploaded_pos DISABLE ROW LEVEL SECURITY;

-- 8. Optional: Add status to purchase_orders (if you want PO status tracking)
